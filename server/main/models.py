...
class NewsModel(models.Model):
    ...
    pictures = models.ManyToManyField(PicturesModel, verbose_name="Изображения новости", blank=True)
    popular = models.BooleanField(("Популярно?"), default=False)
    picture_count = models.IntegerField(("Количество изображений"), default=0)
    short_description_uz = models.TextField(blank=True, verbose_name='Краткое описание (узбекский)')
    short_description_en = models.TextField(blank=True, verbose_name='Краткое описание (английский)')
    short_description_ru = models.TextField(blank=True, verbose_name='Краткое описание (русский)')
...
class PhotoGalery(models.Model):
    ...
    pictures = models.ManyToManyField(PicturesModel, verbose_name="Изображения галереи", blank=True)
...
class UsefulLinks(models.Model):
    ...
    title_uz = models.CharField(("Узбекский заголовок полезной ссылки"), max_length=100, blank=True)
    title_en = models.CharField(("Заголовок полезной ссылки на английском"), max_length=100, blank=True)
    title_ru = models.CharField(("Русский заголовок полезной ссылки"), max_length=100, blank=True)
...
class LaboratoryModel(models.Model):
    ...
    fio_ru = models.CharField(("Полное имя кандидата на русском (Фамилия, Имя, Отчество)"), max_length=200)
    fio_en = models.CharField(("Полное имя кандидата на английском (Фамилия, Имя, Отчество)"), max_length=200)
    fio_uz = models.CharField(("Полное имя кандидата на узбекском (Фамилия, Имя, Отчество)"), max_length=200)
    organized_date = models.DateField(("Год основания"))
    in_position = models.DateField("Дата начала работы кандидата")
    position_ru = models.CharField(("Род деятельности кандидата на русском"), max_length=100)
    position_en = models.CharField(("Род деятельности кандидата на английском"), max_length=100)
    position_uz = models.CharField(("Род деятельности кандидата на узбекском"), max_length=100)
    ...
    degree_en = models.CharField(("Академическая степень на английском"), max_length=100)
...
class HomeAboutModel(models.Model):
    title_uz = models.CharField(("Узбекский заголовок раздела 'О нас' на главной странице"), max_length=300, blank=True, null=True)
    title_en = models.CharField(("Заголовок раздела 'О нас' на главной странице на английском"), max_length=300, blank=True, null=True)
    title_ru = models.CharField(("Русский заголовок раздела 'О нас' на главной странице"), max_length=300, blank=True, null=True)
    text1_uz = models.TextField(("Узбекский текст первого абзаца раздела 'О нас' на главной странице"), blank=True, null=True)
    text1_en = models.TextField(("Текст первого абзаца раздела 'О нас' на главной странице на английском"), blank=True, null=True)
    text1_ru = models.TextField(("Текст первого абзаца раздела 'О нас' на главной странице на русском"), blank=True, null=True)
    text2_uz = models.TextField(("Узбекский текст второго абзаца раздела 'О нас' на главной странице"), blank=True, null=True)
    text2_en = models.TextField(("Текст второго абзаца раздела 'О нас' на главной странице на английском"), blank=True, null=True)
    text2_ru = models.TextField(("Текст второго абзаца раздела 'О нас' на главной странице на русском"), blank=True, null=True)
...
class ManagementModel(models.Model):
    ...
    name_uz = models.CharField(("Узбекское полное имя (Имя, Фамилия и Отчество)"), max_length=200)
    name_ru = models.CharField(("Русское полное имя (Имя, Фамилия и Отчество)"), max_length=200)
    name_en = models.CharField(("Английское полное имя (Имя, Фамилия и Отчество)"), max_length=200)
    ...
    admission_days = models.ManyToManyField(Weekend, verbose_name="Выберите дни приема", blank=True)
...
class Announce(models.Model):
    pictures = models.ManyToManyField(PicturesModel, verbose_name="Изображение", blank=True)
