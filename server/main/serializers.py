...
class ContactSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Contacts
        fields = ['phone_number', 'email', 'addrees', 'facebook', 'telegram', 'instagram']
...
class BannerUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = BannerModel
        fields = ['title_uz', 'title_en', 'title_ru', 'text_uz', 'text_en', 'text_ru', 'img']


class AboutCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = AboutModel
        fields = ['text_1_uz', 'text_1_en', 'text_1_ru', 'text_2_uz', 'text_2_en', 'text_2_ru']
...
class AboutUpdateSerializer(serializers.ModelSerializer):
    class Meta:
        model = AboutModel
        fields = ['id', 'text_1_uz', 'text_1_en', 'text_1_ru', 'text_2_uz', 'text_2_en', 'text_2_ru']
...
class NewsCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'description_uz', 'description_en', 'description_ru', 'short_description_uz',
            'short_description_en', 'short_description_ru',
            'pictures', 'popular', 'created_at', 'updated_at'
        ]
...
class NewsDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = NewsModel
        fields = ['id', 'title', 'description', 'short_description', 'pictures', 'popular', 'picture_count', 'created_at', 'updated_at']
...
class MailCreateSerializer(serializers.Serializer):
    name = serializers.CharField(max_length=100, required=True, help_text="Name of the person submitting the request")
    phone = serializers.CharField(max_length=15, required=True, help_text="Phone number of the person submitting the request")
    message = serializers.CharField(required=True, help_text="Message content of the request")
...
class LaboratoryDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LaboratoryModel
        fields = ['id', 'title', 'description', 'organized_date', 'img', 'avatar', 'fio', 'position', 'in_position', 'degree', 'email', 'phone']
...
class ManagementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'bio', 'position', 'avatar', 'email', 'phone', 'admission_days', 'admission_start_time', 'admission_end_time']    
    ...
    def get_admission_days(self, obj):
        ...
        admission_days_list = [getattr(weekend, field_name) for weekend in admission_days]
...
class AnnounceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Announce
        fields = ['id', 'title', 'text', 'body', 'pictures', 'picture_count', 'published_date']
